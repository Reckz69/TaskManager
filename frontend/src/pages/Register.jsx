...
const Register = () => {
  ...
  return (
    // 🧊 CRYSTAL AZURE BG: Faint bluish-glass gradient
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#f0f9ff] via-[#e0f2fe] to-[#f8fafc] flex items-center justify-center px-4 py-20 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-[500px] z-10 relative">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="w-16 h-16 bg-gradient-to-tr from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-200 mb-6 -rotate-3">
          ...
          <h1 className="text-3xl font-black tracking-tighter text-slate-800 uppercase">
            Join Everest<span className="text-blue-500">.</span>
          </h1>
          <p className="text-slate-500 text-[10px] tracking-[0.4em] uppercase mt-2 font-bold text-center italic">
            Focus like still water. Start your climb.
          </p>
        </div>

        {/* --- REGISTER CARD: FAINT BLUE GLASS --- */}
        <div className="bg-white/60 backdrop-blur-2xl rounded-[3rem] p-10 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-white/80 relative">
            ...
            >
              ...
              <div className="relative w-full py-4 bg-blue-600 text-white font-black rounded-2xl hover:bg-indigo-700 transition-all flex items-center justify-center gap-3 shadow-lg shadow-blue-100 active:scale-95">
                {isSubmitting ? (
                  ...
                  <>
                    <span className="uppercase tracking-widest text-xs">Begin the Journey</span>
        ...
        {/* --- SECURITY FOOTER --- */}
        <div className="mt-10 flex justify-center items-center gap-3 text-slate-300 opacity-60">
           <ShieldCheck size={18} />
           <span className="text-[10px] font-black uppercase tracking-[0.3em]">Privacy-First Peak Security</span>
        </div>
      </div>
    </div>
  );
...
/* --- EVEREST BRANDED INPUT: LIGHT GLASS STYLE --- */
  ...
  <div className="space-y-2">
    ...
    <div className="relative group">
      ...
      <input
        ...
        className="w-full pl-12 pr-4 py-4 bg-white/50 border-2 border-transparent rounded-2xl focus:outline-none focus:border-blue-400 focus:bg-white text-slate-800 font-bold transition-all text-sm shadow-inner placeholder:text-slate-300"
        required
      />
    </div>
  </div>
